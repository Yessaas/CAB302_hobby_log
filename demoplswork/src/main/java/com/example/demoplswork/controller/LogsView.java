...
public class LogsView {
    ...
    private VBox createLogModule() {
        ...
        // Create a new Logs object with the captured name (empty to-do items, images, materials for now)
        ...
        viewButton.setOnAction(actionEvent -> {
            try {
                // int selectedLogId = logsTable.getSelectionModel().getSelectedItem().getId();
